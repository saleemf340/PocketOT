...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("za.co.pocketot.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("za.co.pocketot.security.DomainUserDetailsService", "createSpringSecurityUser");
